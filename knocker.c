...
//  strcpy(source_ip , "152.14.93.168");
  strcpy(source_ip , localIPAddress);
...
//  printf("linenumber of configuration-file: %d\n", linenumber);
  ...
  strncpy(ifr.ifr_name, "eth1", IFNAMSIZ-1); //read local IP address from interface, "eth1" works for Ubuntu 14.04 base on VCL
...
//  printf("%s\n", inet_ntoa(((struct sockaddr_in *)&ifr.ifr_addr)->sin_addr));
  ...
  strncpy(localIPAddress, inet_ntoa(((struct sockaddr_in *)&ifr.ifr_addr)->sin_addr), sizeof localIPAddress - 1);
